...
command="eval" transaction_id="8">
  <property address="-1075781072" type="array" 
    children="1" numchildren="1" page="0" pagesize="32">
    <property name="0" address="-1253446840" type="array"
...
""", '$testarr', 'php')
        ...
        self.assertEqual(prop.child_count(),1)

        self.assertEqual(prop.children[0].type,'string')
